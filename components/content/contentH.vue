  ...
  <section class="text-gray-600 body-font dark:text-gray-400 dark:bg-gray-900">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col">
        <div class="h-1 bg-gray-200 rounded overflow-hidden dark:bg-gray-800">
          <div :class="`w-24 h-full bg-${theme}-500`"></div>
        </div>
      ...
      <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
        <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
          ...
          <h2 class="text-xl font-medium title-font text-gray-900 mt-5 dark:text-white">Shooting Stars</h2>
          ...
          <a :class="`text-${theme}-500 inline-flex items-center mt-3 dark:text-${theme}-400`"
            >Learn More
            <svg
              fill="none"
              stroke="currentColor"
        ...
        <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
          ...
          <h2 class="text-xl font-medium title-font text-gray-900 mt-5 dark:text-white">The Catalyzer</h2>
          <p class="text-base leading-relaxed mt-2">
            Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
            dreamcatcher neutra, ethical XOXO lumbersexual.
          </p>
        ...
        <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
          ...
          <h2 class="text-xl font-medium title-font text-gray-900 mt-5 dark:text-white">The 400 Blows</h2>
          <p class="text-base leading-relaxed mt-2">
            Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
            dreamcatcher neutra, ethical XOXO lumbersexual.
          </p>
